...
import { Table, Button, Space, Drawer, Form, Input, Select, message, Popconfirm, Tag, Card } from 'antd';
import type { ColumnsType } from 'antd/es/table';
import { getTemplatePage, createTemplate, updateTemplate, deleteTemplate, updateTemplateStatus } from '../../api/template';
